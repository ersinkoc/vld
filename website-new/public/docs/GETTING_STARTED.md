...
A comprehensive guide to get you up and running with VLD (v2.4.0), the blazing-fast TypeScript validation library with Zod-compatible root and subpath APIs, AOT compile support, modular architecture, plugin system, and CLI tools.
...
VLD v2.4.0 provides multiple import options for different needs:
